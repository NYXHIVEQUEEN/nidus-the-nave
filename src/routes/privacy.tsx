...
function Privacy() {
  return (
    <LegalPage title="PRIVACY">
      ...
      <p>
        <strong className="text-gilt">Erase.</strong> NEW HIVE in RITE wipes the live save after you confirm. Clearing site data or uninstalling does the same. Three local slots (STASH / LOAD) are also only on-device.
      </p>
      <p>
