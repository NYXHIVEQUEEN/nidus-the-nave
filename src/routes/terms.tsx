...
function Terms() {
  return (
    <LegalPage title="TERMS">
      ...
      <p>
        <strong className="text-gilt">Purchases.</strong> Sovereign heroes are one-time purchases through Google Play or the Microsoft Store: $0.99 each or $9.99 for all twenty, in your local currency. Double Tithe is a one-time $2.99 purchase that permanently doubles ore, parts, spark, and cut income. A purchase unlocks that hero on every device signed in to the same store account. Refunds follow that store's policy. The game stays fully playable without buying anything.
      </p>
      <p>
