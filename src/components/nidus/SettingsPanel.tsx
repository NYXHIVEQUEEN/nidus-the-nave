...
const CODEX: { id: string; title: string; body: string }[] = [
  ...
  { id: "surge", title: "SURGE", body: "A short scream. All rates spike. Pair with Nytheria’s breakdown." },
  { id: "slag", title: "SLAG", body: "Tap the hull. Spare ore and a lick of spark. Seven second cool." },
  { id: "idle", title: "IDLE GIFT", body: "Leave. Come back. Claim the extra cut. The hive does not sleep." },
