...
Combined rebuild after the App Builder tree was not mounted in this chat:
...
The Three.js hull from the builder session is not in this repo.

## GitHub

Repo: `NYXHIVEQUEEN/nidus`. Add `assets/` (mp3 + sky jpgs) if the clone is source-only.
