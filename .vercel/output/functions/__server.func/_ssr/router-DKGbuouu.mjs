...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DKGbuouu.js
var router_DKGbuouu_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Drh5W7Zu.css";
var APP_NAME = "NIDUS";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Gothic cathedral station. Idle hive. Sentient Command."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-BM-JuxA9.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_DKGbuouu_exports as t };
